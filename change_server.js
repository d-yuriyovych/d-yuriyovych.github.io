...
function startMe() { 
    ...
    // Логіка автоматичного редиректу
    ...
    // 1. ПЕРШИЙ РЯДОК: ПОТОЧНИЙ СТАТУС (З ГАЛОЧКОЮ)
    ...
    Lampa.SettingsApi.addParam({
        ...
        onSelect: function() {
            ...
            if (target && target !== '-') {
                ...
                Lampa.Noty.show('Ви вже на цьому сервері або сервер не вибрано');
            }
        },
        onRender: function(item) {

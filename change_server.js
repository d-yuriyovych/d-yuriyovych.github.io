From: <Saved by Blink>
Snapshot-Content-Location: https://skaz.tv/r.js
Subject: 
Date: Sat, 27 Dec 2025 23:50:50 +0200
MIME-Version: 1.0
Content-Type: multipart/related;
	type="text/html";
	boundary="----MultipartBoundary--skw0udO60Dsk1GA2EZfvamvmhCuirporHT3xpTkJoO----"


------MultipartBoundary--skw0udO60Dsk1GA2EZfvamvmhCuirporHT3xpTkJoO----
Content-Type: text/html
Content-ID: <frame-FA8E55CCB623422B13A69088C1D603B5@mhtml.blink>
Content-Transfer-Encoding: binary
Content-Location: https://skaz.tv/r.js
...
function startMe() {
	...
	if (window.location.search!='?redirect=1') {
		if(window.location.hostname!=Lampa.Storage.get('location_server')) {
			if (Lampa.Storage.get('location_server')!='-' &amp;&amp; Lampa.Storage.get('location_server')!='') window.location.href = 'http://'+Lampa.Storage.get('location_server')+'?redirect=1';
		}
  } else {Lampa.Storage.set('location_server','-');}

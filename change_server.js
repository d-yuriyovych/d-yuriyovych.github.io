(function () {
    ...
    // ПОВНІСТЮ ЗБЕРЕЖЕНА ФУНКЦІЯ З ВЕРСІЇ 8
    ...
    function init() {
        // Твій метод реєстрації через SettingsApi
        ...
        // Додаємо пункт, який просто викликає функцію openServerModal()
        ...
        // Пряма вставка в налаштування, щоб уникнути помилки undefined
        Lampa.Settings.listener.follow('open', function (e) {
            if (e.name === 'server_redirect_mod') {
                setTimeout(function() {
                    $('.settings__item').addClass('selector').off('click').on('click', openServerModal);
                }, 100);
            }
        });

        // Кнопки в Header та Menu (З Версії 8)
